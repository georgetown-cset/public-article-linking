...
with DAG("article_linkage_updater",
    ...
    # Start up your linkage vm, update simhash indexes of title+abstract, run simhash, then create the
    # merge ids
    ...
    # turn off the expensive linkage vm when we're done with it, then import the id mappings and
    # lid back into BQ
